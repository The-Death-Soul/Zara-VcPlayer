...
from ZaraMusic.callsmusic import client as USER
...
async def play(_, message: Message):
    ...
    Zain = await message.reply("» ᴘʀᴏᴄᴇssɪɴɢ​... ᴘʟᴇᴀsᴇ ᴡᴀɪᴛ ʙᴀʙʏ🔎")
    ...
    if int(chat_id) in ACTV_CALLS:
        ...
        await ZaraMmusic.pytgcalls.join_group_call(
                chat_id, 
                InputStream(
                    InputAudioStream(
                        file_path,
