...
from ZaraMusic import client as USER
    ...
    if PMPERMIT == "ENABLE":
        if PMSET:
            ...
            await USER.send_message(
                message.chat.id,
                f"ʜᴇʏ {message.from_user.mention()},\nᴛʜɪs ɪs [{bn}](t.me/{lel}) ʙᴏᴛ ᴀssɪsᴛᴀɴᴛ ᴀᴄᴄᴏᴜɴᴛ.\n\nᴅᴏɴ'ᴛ ᴛʀʏ ᴛᴏ sᴘᴀᴍ ʜᴇʀᴇ ᴇʟsᴇ ʏᴏᴜ ᴡɪʟʟ ɢᴇᴛ ꜰᴜ*ᴋᴇᴅ ʙʏ [ᴢᴀʀᴀ](t.me/{OWNER_USERNAME}).\n",
        reply_markup=InlineKeyboardMarkup(
            [
                [
                    ...
                    InlineKeyboardButton(
                        "🥂sᴜᴩᴩᴏʀᴛ🥂", url="https://t.me/+TFNht-Xwon1lM2Y1"
                    )
                ],[ 
                    InlineKeyboardButton(
